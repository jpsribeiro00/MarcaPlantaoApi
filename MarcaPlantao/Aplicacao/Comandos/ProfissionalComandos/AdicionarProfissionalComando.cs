...
{
    public class AdicionarProfissionalComando : Comando
    {
        ...
        {
            ResultadoValidacao = new AdicionarProfissionalValidacao().Validate(this);
            return ResultadoValidacao.IsValid;
        }
    }

    public class AdicionarProfissionalValidacao : AbstractValidator<AdicionarProfissionalComando>
    {
        public AdicionarProfissionalValidacao()
        {
