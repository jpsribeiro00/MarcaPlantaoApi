...
namespace MarcaPlantao.Aplicacao.Comandos.ProfissionalComandos
{
    public class AtualizarProfissionalComando : Comando
    {
        ...
        public AtualizarProfissionalComando(Guid id, string nome, DateTime dataNascimento, string genero, string telefone, byte[]? imagem, string cRM, string cPF, string userId, List<OfertaDados> ofertas, List<EspecializacaoDados> especializacoes)
        {
            Id = id;
            Nome = nome;
